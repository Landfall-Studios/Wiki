    ...
    if (text) {
      ...
      if (fileData.dates) {
        ...
        if (createdDate) {
          segments.push(
            <span>
              Created: <DateComponent date={createdDate} locale={locale} />
            </span>,
          );
        }
        ...
        if (fileData.filePath) {
          try {
            const st = fs.statSync(fileData.filePath);
            segments.push(
              <span>
                Updated: <DateComponent date={new Date(st.mtimeMs)} locale={locale} />
              </span>,
            );
          } catch {}
        }

...
These acts were initially treated by the Imperial authorities as the symbolic vandalism of an unwell individual. A criminal case (Case No. 572-LIR-NT) was filed under the [[Criminal Code Act (1-LCC)|Lilaris Criminal Code]] for trespass ([[Criminal Code Act (1-LCC)|§ 4.2.2.2]]), criminal mischief ([[Criminal Code Act (1-LCC)|§ 4.2.3.2]]), and treason ([[Criminal Code Act (1-LCC)|§ 4.4.1.2]]), but stalled in early proceedings.
...
In the same period, [[The Annexation of Whitefall|the township of Merlot]] peacefully seceded from the Idesian Empire under Mayor Ashling Goldwound, who cited "the ideological collapse and radicalization of the Idesian regime under Larrist extremism." The township was renamed Whitefall and integrated into [[The Second Lilaris Empire]]. The annexation is the clearest political evidence available that Larrism had moved beyond eccentricity into something its host population considered an existential threat to civic governance.

### The People v. Huge Larry

In the immediate aftermath of the Princess Salem Incident, Empress [[Kara A. Ehrveil]] filed [[Case Filing - The People v. Huge Larry|Case No. 593-LIR-NT]] in the New Terranova Imperial Court under the [[Lilaris Department of Justice Act]]. The filing consolidated the earlier vandalism charges with new charges arising from the Princess Salem Incident under the [[Criminal Code Act (1-LCC)|Criminal Code Act]]: assault ([[Criminal Code Act (1-LCC)|§ 4.1.2.1]]), battery ([[Criminal Code Act (1-LCC)|§ 4.1.2.2]]), unlawful assembly ([[Criminal Code Act (1-LCC)|§ 4.3.1.2]]), treason for the symbolic exile of royalty ([[Criminal Code Act (1-LCC)|§ 4.4.1.2]]), and aiding the escape of a known felon (derived under [[Criminal Code Act (1-LCC)|§ 4.4.1.2 and § 4.2.2.1]]). Jurisdiction was claimed under [[Criminal Code Act (1-LCC)|§ 5.3]] on the grounds that the victim was a royal citizen, that the incident occurred on unclaimed land, and that [[New Ides]] under Isaac Acentino lacked a codified legal system capable of impartial prosecution. The filing also formally requested the suspension of all Larry Cult activities pending review of its threat to national stability.
...
Larrism is the wiki's clearest case study in the mechanics of a high-control religious movement. The angles below name the elements that made it dangerous and durable, in roughly the order they apply to a person being drawn in.

### 1. The Person at the Center

A movement built entirely on the person of a single living figure carries no internal correction. There is no scripture against which the godhead can be cross-checked, no clergy with standing to dissent, no doctrine of his fallibility. Whatever the godhead says becomes the faith. This is the structural condition that produced both Isaac Acentino's drafting of Idesian state policy around Larry's pronouncements and the assault on Princess Salem when Larry himself cut at her with a sword. The faith had no doctrine to constrain what its godhead could do.

This is also the condition that protects the godhead. Any internal voice that says "this is wrong" can be answered by "he is god and you are not." Without a body of scripture or a tradition older than the man, there is no place to stand from which to disagree.

### 2. Bundled Sacraments as Trap

Larrism's most consequential doctrinal innovation was the binding of baptism and marriage into a single act. Baptism is the rite of belonging; marriage is the rite of personal contract. Treating them as inseparable means that one cannot become a full member of the faith without simultaneously becoming bound to another person in marriage under the faith's terms, and one cannot exit either without exiting both.
...
A finite supply of sacred recognition creates ranking among the faithful. Members can be compared, sorted, and made to compete for proximity to the godhead. The bread also creates a soft form of sunk cost: a follower who has received their loaf has been singled out, and walking away from the faith means walking away from the artifact that says they were chosen. This is not the most coercive structure inside Larrism, but it is one of the small architectures that make voluntary exit harder than it sounds in theory.

### 4. The Right to Exile

Larrist adherents in positions of state authority claimed the right to declare outsiders "exiled" from the faith. Isaac Acentino exercised this purported power against Princess Salem despite holding no jurisdiction over her. Inside the movement the same power operated against members who fell out of favor.

The right to declare a person outside the faith is the right to remove their standing in the only community that has been allowed to matter to them. Where a movement also captures a polity, as Larrism did in the Idesian and ExoVinian Empires, the religious exile becomes a civic one. The same mechanism that severs a member from their congregation severs them from their nation. This is one of the standard tools of high-control groups, and it works because the cost of refusal scales with how much of a person's life the group has already absorbed.

### 5. State Capture

The two empires that built policy around Larry's pronouncements did not become Larrist by accident. Their sitting leadership chose the faith and used the apparatus of the state to embed it. Domestic policy was drafted around the godhead's pronouncements; the criminal apparatus was bent to protect adherents and pursue critics; the dispute between two members of the cult, or between an adherent and a skeptic, was no longer a private matter.
...
These are not the same case. The wiki does not flatten them into a single judgment. The principle that informed conviction is required for moral responsibility, taken seriously, applies to cult members as much as to citizens of any regime; the principle that participation in harm carries weight regardless of belief applies to them as well. Both are true, and the way they apply to any given adherent depends on what they did, what they knew, what was done to them, and what they did when the opportunity to step away appeared. Survivor framings of cult exit, the work of disentangling belief, identity, community, and self that follows leaving, take this complexity seriously because it is the only way the work can actually be done.

### 7. What Was Done to the Survivors

The post-Veil treatment of Larrist communities by Sovarre is the part of the record most often skipped over in summary accounts. The Night of the Veil killed the cult's leadership in a single coordinated strike. The week that followed killed substantial numbers of ordinary members in their homes, their chapels, and their settlements through the explosions Sovarre conducted across the former Larrist territories. [[Amlooi's Diary]] records the destruction of the mansion he had been given, the wine cellar of his old friend, and the chapel in which he had received his bread.
...
- [[Case Filing - The People v. Huge Larry|Case Filing: The People v. "Huge Larry" et al. (Case No. 593-LIR-NT)]]
